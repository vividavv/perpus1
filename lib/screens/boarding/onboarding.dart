    ...
    return Column(
      children: [
        ...
        Text(
          ...
          style: 
          TextStyle(fontFamily: GoogleFonts.poppins().fontFamily, color: Colors.white, fontSize: 28)
        ),
        const SizedBox(height: 16),
        Text(
          description,
          textAlign: TextAlign.left,
          style: TextStyle(fontFamily: GoogleFonts.poppins().fontFamily, color: Colors.white),
        ),
        const Spacer(),
      ]
    );
